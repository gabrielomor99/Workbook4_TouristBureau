 ...
 let activities = [
    {
        ...
        location: "Location: 121 S. Main Street",
        price: "Price: 265.00"
    },
    {
        category: "Adventures",
    ...
    },
    {
        ...
        location: "Location: 1991 Paint Drive",
        price: "Price: 40.00"
    },
    {
        category: "Arts & Crafts",
    ...
    },
    {
        ...
        location: "Location: 101 Airfield Drive",
        price: "Price: 10.00"
    },
    {
        category: "Museums",
        ...
        location: "Location: 1056 Lost Knives Court",
        price: "Price: 3.00"
    },
    {
        category: "Museums",
        ...
        location: "Location: 103 Technology Way",
        price:"Price: 0.00"
    },
    {
        ...
        location: "Location: 10987 FM 1187",
        price: "Price: 12.00"
    },
    {
        category: "Wine Tastings",
        ...
        location: "Location: 121 Burleson Court",
        price: "Price: 0.00"
    },
    {
        category: "Other",
        ...
        location: "Location: 10 Redline Drive",
        price: "Price: 25.00"
    },
    {
        category: "Other",
        ...
        location: "Location: Call (555) 555-5555",
        price: "Price: 0.00"
    }
];
...
window.onload = function () {
    ...
    selectCategoriesEl.onchange = function () {
        ...
        selectActivitiesEl.options.length = 0; // Resetting all options
    ...
    selectActivitiesEl.onchange = function () {
        ...
        let activityDetailsEl = document.getElementById("activity-details");
        let activityLocationEl = document.getElementById("activity-location")
        let activityPriceEl = document.getElementById("activity-price")

        for (let activity of activities) {
            if (activity.name === activitySelected) {
                activityDetailsEl.innerHTML = activity.description;
                activityLocationEl.innerHTML = activity.location;
            }
            if (activity.name === activitySelected) {
                activityLocationEl.innerHTML = activity.location;
            }
            if (activity.name === activitySelected) {
                activityPriceEl.innerHTML = activity.price;
            }
        }
